  ...
  return (
    <div className="flex min-h-screen flex-col bg-base xl:flex-row">
      ...
      <section className="relative hidden flex-1 overflow-hidden xl:block">
        {/* Prajurit ditambatkan di kiri-bawah supaya bagian atas panel bebas untuk judul. */}
        <div className="absolute bottom-0 left-0 h-[74%] w-[300px]">
          <Image src="/brand/prajurit.jpg" alt="" fill sizes="300px" className="object-cover object-top" />
        ...
        <Image
          ...
          height={352}
          sizes="70vw"
          className="pointer-events-none absolute right-[2%] top-[27%] w-[70%] max-w-[680px] mix-blend-screen [mask-image:radial-gradient(ellipse_at_center,#000_60%,transparent_95%)]"
        />
        ...
        <div className="relative z-10 flex h-full flex-col p-12">
          ...
          <div className="absolute right-12 top-12 rounded-[10px] border border-border-soft bg-base/60 px-5 py-4 backdrop-blur-sm">
          ...
          <div className="mt-auto pl-[292px]">
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-[14px]">
              {FITUR.map(({ icon: Icon, judul, isi }) => (
                <div key={judul} className="flex items-start gap-3">
                  <div className="flex size-9 shrink-0 items-center justify-center rounded-[8px] border border-accent-bright/25 bg-accent-bright/[0.07] text-accent-bright">
      ...
      {/* Panel form */}
      <section className="flex w-full items-center justify-center p-6 xl:w-[520px] xl:shrink-0 xl:border-l xl:border-border-soft xl:bg-gradient-to-b xl:from-[#080b0d] xl:to-[#020304] xl:p-10">
        <div className="hud-brk hud-panel w-full max-w-[400px] rounded-[16px] border border-border p-7 shadow-[0_40px_100px_rgba(0,0,0,0.92),0_0_60px_rgba(60,242,154,0.06)]">
